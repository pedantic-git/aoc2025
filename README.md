...
Here's where I keep track of my solutions to [Advent of Code 2025](https://adventofcode.com/2025).

**Warning**: There may be spoilers inside!

## How to run

Most of the entries take advantage of Ruby's `ARGF` so they can be run by
